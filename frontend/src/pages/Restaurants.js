    ...
    <div className="min-h-screen bg-orange-300 flex items-center justify-center p-6">
      <div className="bg-white p-10 rounded-lg shadow-xl max-w-4xl w-full">
        <div className="flex justify-between items-center mb-4">
          ...
          <h1 className="text-4xl font-bold text-center text-gray-800">Restaurants</h1>
          <div className="w-16"></div> 
        </div>
        <p className="text-center text-lg text-gray-600 mb-8">Discover the best restaurants to eat a francesinha.</p>
        <RestaurantList />
      </div>
    </div>
  );
